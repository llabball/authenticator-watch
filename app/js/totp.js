...
var jsSHA = this.jsSHA;

(function (lib) {
    if (typeof module !== "undefined" && module.exports) {
        module.exports = lib; // CommonJS
    } else if (typeof module === "undefined" && typeof exports === "object") {
        exports.HOTP = lib; // couchapp
  ...
  var lib = {}
    ;   
         ...
         lib.version = "0.1.0";
          lib.getOTP = getOTP;
    lib.randomBase32 = randomBase32;


    function getOTP(base32) {
        var base32hash = base32 || randomBase32(16);
        var key = base32tohex(base32hash);
